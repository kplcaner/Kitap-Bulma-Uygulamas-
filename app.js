let kitap1 = { isim: "herseyı dusunme", yazar: "anne bogel", fiyat: 25, raf: "1.5.RAF" }
let kitap2 = { isim: "hiç bir karsılasma tesaduf degıldır ", yazar: "hakan menguc ", fiyat: 50, raf: "2.3.RAF" }
let kitap3 = { isim: "zafer sızlanarak kazanılmaz ", yazar: "haluk tatar", fiyat: 45, raf: "3.4.RAF" }
let kitap4 = { isim: "insan neyle yasar", yazar: "tolstoy", fiyat: 34, raf: "4.1.RAF" }
let kitap5 = { isim: "seker portakalı ", yazar: "caner kipel", fiyat: 100, raf: "5.3.RAF" }
